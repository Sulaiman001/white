...
next)){clearTimeout(t);var b=$("#wt-list-item-input-"+a).val(),b=b.replace(/'/,"\\'");t=setTimeout("saveText('"+a+"', '"+b+"')",500)}})},doApplySaveOnEnter=function(a,c){if(editing||$("#wt-list-item-input-0").is(":focus")){editing=!1;c.preventDefault();var b=a.data("id");console.log("id: "+b);var e=$("#wt-list-item-input-"+b).val();0===b?saveText(null,e):($("#wt-list-item-"+b).html('<p class="wt-list-item-text"><input type="checkbox" data-id="'+b+'" class="wt-list-item-chk-done btn-tooltip" id="wt-list-item-chk-done-'+
b+'" title="'+removeTitle()+'" /> <input type="checkbox" data-id="'+b+'" class="wt-list-item-chk-strike btn-tooltip" id="wt-list-item-chk-strike-'+b+'" title="'+strikeTitle()+'" /> <span id="wt-text-'+b+'" class="wt-text" data-id="'+b+'">'+e+"</span></p>"),applyEditItem(b),applyRemoveItem(b),applyStrikeItem(b),applySaveTextOfItem(b),applySaveOnEnter(b),applyTooltip(),saveText(b,e));a.val("")}},applySaveOnEnter=function(a){$("#wt-list-item-input-"+a).keypress(function(a){var b=$(this);b.on("blur",
function(){doApplySaveOnEnter(b,a)});13==a.which&&doApplySaveOnEnter(b,a)})},applyTooltip=function(){/iPhone|iPod|iPad|Android|BlackBerry|phone/i.test(navigator.userAgent)||$(".btn-tooltip").tooltip()},init=function(){var a=window.location.hash,a=a.replace(/^#/,""),a=a.split("/");switch(a[1]){case "list":list=a[2];startConnection(list);load(list);break;default:list="public",startConnection(list),load(list)}},load=function(a){$(".wt-list-item").remove();$("title").text("#"+a);$.getJSON("ajax.php?a=load&list="+
encodeURIComponent(a),function(a){var b=0;$.each(a.items,function(a,c){var d=c.id,f=c.text;0===a&&(b=0);var g=c.strike?"wt-strike":"",h=c.strike?'checked="checked"':"";$("#wt-list-item-"+b).after('<div id="wt-list-item-'+d+'" class="wt-list-item" data-id="'+d+'"><p class="wt-list-item-text"><input type="checkbox" data-id="'+d+'" class="wt-list-item-chk-done btn-tooltip" id="wt-list-item-chk-done-'+d+'" title="'+removeTitle()+'" /> <input type="checkbox" data-id="'+d+'" class="wt-list-item-chk-strike btn-tooltip" id="wt-list-item-chk-strike-'+
d+'" '+h+' title="'+strikeTitle()+'" /> <span id="wt-text-'+d+'" class="wt-text '+g+'" data-id="'+d+'">'+f+"</span></p></div>");applyEditItem(d);applyRemoveItem(d);applyStrikeItem(d);applyTooltip();b=d})})};
