...
$(".wt-list-item").remove();$("title").text("all lists");$.getJSON("services/load-all/"+encodeURIComponent(getHashVar(2)),function(a){var c=$(a.items).size(),b=Math.floor(c/4),d=c-3*b,e=$(".wt-list");4<=c?(e.append("<div class='row'><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-1'></div><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-2'></div><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-3'></div><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-4'></div></div>"),$.each(a.items,
function(a,c){var e=a+1;(e<=d?$("#list-col-1"):e>d&&e<=d+1*b?$("#list-col-2"):e>d+1*b&&e<=d+2*b?$("#list-col-3"):$("#list-col-4")).append('<div class="wt-all-list-item" data-list="'+escapeHtml(c)+'"><a title="#'+escapeHtml(c)+'" href="#/list/'+escapeHtml(c)+"/"+getHashVar(2)+'">#'+escapeHtml(c)+"</a></div>")}),e.append("</div>")):(e.append("<div class='row'><div class='columns small-12 medium-12 large-12' id='list-col-1'></div></div>"),$.each(a.items,function(a,b){$("#list-col-1").append('<div class="wt-all-list-item" data-list="'+
