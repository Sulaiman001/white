...
"#/list/"+$(this).data("list")+"/"+getHashVar(2)})},applyTooltip=function(){/iPhone|iPod|iPad|Android|BlackBerry|phone/i.test(navigator.userAgent)||$(".btn-tooltip").tooltip()},menuToggle=function(){$(".menu-toggle").click(function(a){a.preventDefault();$("#wrapper").toggleClass("toggled")})},init=function(){var a=window.location.hash,a=a.replace(/^#/,""),a=a.split("/");startConnection();switch(a[1]){case "list":list=a[2];load(list);break;case "lists":loadAll();break;default:list="public",load(list)}menuToggle()},
isUndefined=function(a){return void 0===a},getHashVar=function(a){return window.location.hash.replace(/^#/,"").split("/")[a]},loadAll=function(){$("#wt-list-item-0").hide();$(".wt-list-item").remove();$("title").text("all lists");$.getJSON("services/load-all/"+encodeURIComponent(getHashVar(2)),function(a){var c=$(a.items).size(),b=Math.floor(c/4),d=c-3*b,f=$(".wt-list");4<=c?(f.append("<div class='row'><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-1'></div><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-2'></div><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-3'></div><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-4'></div></div>"),
$.each(a.items,function(a,c){var f=a+1;(f<=d?$("#list-col-1"):f>d&&f<=d+1*b?$("#list-col-2"):f>d+1*b&&f<=d+2*b?$("#list-col-3"):$("#list-col-4")).append('<div class="wt-all-list-item" data-list="'+escapeHtml(c)+'"><a title="#'+escapeHtml(c)+'" href="#/list/'+escapeHtml(c)+"/"+getHashVar(2)+'">#'+escapeHtml(c)+"</a></div>")}),f.append("</div>")):(f.append("<div class='row'><div class='columns small-12 medium-12 large-12' id='list-col-1'></div></div>"),$.each(a.items,function(a,b){$("#list-col-1").append('<div class="wt-all-list-item" data-list="'+
escapeHtml(b)+'"><a title="#'+escapeHtml(b)+'" href="#/list/'+escapeHtml(b)+"/"+getHashVar(2)+'">#'+escapeHtml(b)+"</a></div>")}));applyAllListClick()})},load=function(a){$("#wt-list-item-0").show();$(".wt-list-item").remove();$(".wt-all-list-item").remove();$("title").text("#"+a);$.getJSON("services/load/"+encodeURIComponent(a)+"/"+encodeURIComponent(getHashVar(3)),function(a){var b=0;$.each(a.items,function(a,c){var e=c.id,g=c.text;0===a&&(b=0);var h=c.strike?"wt-strike":"",k=c.strike?'checked="checked"':
"";$("#wt-list-item-"+b).after('<div id="wt-list-item-'+e+'" class="wt-list-item" data-id="'+e+'"><p class="wt-list-item-text"><input type="checkbox" data-id="'+e+'" class="wt-list-item-chk-done btn-tooltip" id="wt-list-item-chk-done-'+e+'" title="'+removeTitle()+'" /> <input type="checkbox" data-id="'+e+'" class="wt-list-item-chk-strike btn-tooltip" id="wt-list-item-chk-strike-'+e+'" '+k+' title="'+strikeTitle()+'" /> <span id="wt-text-'+e+'" class="wt-text '+h+'" data-id="'+e+'">'+escapeHtml(g)+
"</span></p></div>");applyEditItem(e);applyRemoveItem(e);applyStrikeItem(e);applyTooltip();b=e})})},sortByPriority=function(){},handleMessage=function(a){a=JSON.parse(a);if("message"===a.a&&a.list===list)if("strike"===a.actiontype){var c=$("#wt-text-"+a.id);a.strike?c.addClass("wt-strike"):c.removeClass("wt-strike");$("#wt-list-item-chk-strike-"+a.id).prop("checked",a.strike)}else"remove"===a.actiontype?$("#wt-list-item-"+a.id).remove():"add"===a.actiontype?($("#wt-list-item-0").after('<div id="wt-list-item-'+
