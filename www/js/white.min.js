...
loadAll=function(){$("#wt-list-item-0").hide();$(".wt-list-item").remove();$("title").text("all lists");$.getJSON("services/load-all/"+encodeURIComponent(getHashVar(2)),function(a){var c=$(a.items).size(),b=Math.floor(c/4),d=c-3*b,f=$(".wt-list");4<=c?(f.append("<div class='row'><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-1'></div><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-2'></div><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-3'></div><div class='col-sm-12 col-md-6 col-lg-3' id='list-col-4'></div></div>"),
